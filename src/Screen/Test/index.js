...
const Test = ({language, setUserName}) => {
    ...
    const onFinish = (values) => {
        ...
        console.log(moment(values.birth_date._d).format("YYYY-MM-DD HH:mm:ss"))
                ...
                <div className={'form-ariza'}>
                    ...
                    <div className={'form-col-1'}>
                        ...
                        <Form.Item rules={[
                            ...
                            <Select>
                                <option
                                    value="Белоруссия давлат озик-овкат ва кимёвий технологоиялар университети">Белоруссия
                                    давлат озик-овкат ва кимёвий технологоиялар университети
                                </option>
                                <option value="Белоруссия давлат технологоия университети">Белоруссия давлат технологоия
                                    университети
                                </option>
                                <option value="Полоцк давлат университети">Полоцк давлат университети</option>
                                <option value="Янка Купала номидаги Гродво давлат университети">Янка Купала номидаги
                                    Гродво давлат университети
                                </option>
                                <option value="Козон (Волгабуйи) Федерал университети">Козон (Волгабуйи) Федерал
                                    университети
                                </option>
                                <option value="Латвия табиий фанлар ва технология университети">Латвия табиий фанлар ва
                                    технология университети
                                </option>
